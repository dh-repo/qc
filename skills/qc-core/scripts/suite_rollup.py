...
def load_ledgers(findings_dir: Path) -> dict[str, dict] | None:
    ledgers = {}
    for skill in LEGAL_ORDER:
        ...
        try:
            ...
            print(f"FAIL: unreadable ledger {path}: {exc}", file=sys.stderr)
            return None
    return ledgers
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.skipped:
        try:
            ...
            print(f"FAIL: unreadable skipped list {args.skipped}: {exc}", file=sys.stderr)
            return 1
